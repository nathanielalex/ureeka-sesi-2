    ...
    <div className="min-h-screen flex flex-col">
      <section className="flex flex-col-reverse md:flex-row items-center justify-between py-20 px-6 md:px-20 gap-12">
        <div className="md:w-3/5">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/projects">
              <Button className="bg-black text-white hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200 px-6 py-6 rounded-md flex items-center gap-2 text-lg">
            ...
            <Link href="/projects">
              <Button
                variant="outline"
                className="border-black text-black hover:bg-gray-100 dark:border-white dark:text-white dark:hover:bg-gray-900 px-6 py-6 rounded-md flex items-center gap-2 text-lg"
              >
      ...
      <section className="py-20 px-6 md:px-20 bg-gray-50 dark:bg-gray-900">
        ...
        <div className="mt-16 text-center">
          <Link href="/about">
            <Button className="bg-black text-white hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200 px-6 py-6 rounded-md flex items-center gap-2 text-lg mx-auto">
